...
class _SafeZoneScreenState extends State<SafeZoneScreen> {
  ...
  ChildModel? get _child => widget.children.isEmpty
      ? null
      : widget.children[_childIdx.clamp(0, widget.children.length - 1)];

  List<ZoneModel> get _myZones => _child == null
      ? []
      ...
      SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          KCTopBar(
            title: 'Safe Zones',
            sub: ch != null
                ? "${ch.name}'s zones (${_myZones.length})"
                : 'No children',
            onBack: () => _adding
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                              color: sel ? kc : T.border, width: sel ? 1.5 : 1),
                        ),
            ...
            if (_myZones.isEmpty)
              Container(
                ...
                child: Column(children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                      "Tap \"+ Add Zone\" to create ${ch.name}'s first safe zone.\nZones also appear on the map.",
            ...
            // ── Zone cards ───────────────────────────────
              ...
              Container(
                ...
                child: Row(children: [
                  ...
                  Text(
                      '${_myZones.length} zone${_myZones.length > 1 ? 's' : ''} saved — visible on the map',
                      style: TextStyle(
                          color: T.cyan,
                          fontSize: 11,
          ...
          child: Material(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                      color: widget.T.red.withOpacity(0.4),
                      blurRadius: 20,
              ...
              child: Row(children: [
                ...
                Expanded(
                    child: Column(
                        ...
                        children: [
                      Text('${_child?.name ?? 'Child'} left "$_alertZone"!',
                          style: const TextStyle(
                              color: Colors.white,
                              fontSize: 13,
                              fontWeight: FontWeight.w800)),
                      const Text('Child is no longer in this safe zone',
                          style:
            ...
            Row(children: [
              ...
              GestureDetector(
                  ...
                  child: Container(
                      ...
                      child:
                          Icon(Icons.delete_outline, color: T.red, size: 15))),
            ]),
          ]),
        ),
        if (zone.active) ...[
          ...
          Padding(
            ...
            child: Row(children: [
              Expanded(
                  child: _PointTile(label: '🟢 Start', val: zone.start, T: T)),
              const SizedBox(width: 8),
            ...
            child: Container(
              ...
              child:
                ...
                Container(
                    ...
                    height: 8,
                    decoration: BoxDecoration(
                        color: zone.inZone ? T.green : T.red,
                        shape: BoxShape.circle)),
                const SizedBox(width: 8),
                Text(zone.inZone ? 'Child is SAFE ✅' : 'Child NOT in Zone ⚠️',
                    style: TextStyle(
                        color: zone.inZone ? T.green : T.red,
                        fontSize: 12,
                        fontWeight: FontWeight.w700)),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          color: T.card,
          borderRadius: BorderRadius.circular(18),
          border: Border.all(color: T.cyan.withOpacity(0.3), width: 1.5)),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          Container(
              width: 32,
              ...
              child: Icon(Icons.shield_rounded, color: T.cyan, size: 17)),
          const SizedBox(width: 10),
          Text("Add Safe Zone for $childName",
              style: TextStyle(
          ...
          children: presets
              .map((p) => GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          color:
                              preset == p ? T.cyan.withOpacity(0.12) : T.card2,
                          borderRadius: BorderRadius.circular(20),
                          border: Border.all(
                              color: preset == p ? T.cyan : T.border,
                              width: 1.5)),
                      child: Text('${presetIcon(p)} $p',
                          style: TextStyle(
                              color: preset == p ? T.cyan : T.sub,
                              fontSize: 12,
                              fontWeight: preset == p
                                  ? FontWeight.w700
                                  : FontWeight.w400)),
            ...
            children: radii
                .map((r) => Expanded(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            color: radius == r
                                ? T.cyan.withOpacity(0.12)
                                : T.card2,
                            borderRadius: BorderRadius.circular(10),
                            border: Border.all(
                                color: radius == r ? T.cyan : T.border,
                                width: 1.5)),
                        child: Text(r >= 1000 ? '${r ~/ 1000}km' : '${r}m',
                            textAlign: TextAlign.center,
                            style: TextStyle(
                                color: radius == r ? T.cyan : T.sub,
                                fontSize: 12,
                                fontWeight: radius == r
                                    ? FontWeight.w700
                                    : FontWeight.w400)),
        ...
        Center(
            child: Text(
                'Alert when child exits a ${radius >= 1000 ? '${radius ~/ 1000}km' : '${radius}m'} radius',
                style: TextStyle(color: T.muted, fontSize: 11))),
        const SizedBox(height: 14),
        Row(children: [
          Expanded(
              child: PrimaryBtn(label: '🛡️ Save Zone', onTap: onSave, T: T)),
          const SizedBox(width: 8),
          Expanded(
              child: PrimaryBtn(
                  label: 'Cancel', onTap: onCancel, T: T, ghost: true)),
        ]),
      ]),
    );
  }
