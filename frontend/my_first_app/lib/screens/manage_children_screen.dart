...
class _ManageChildScreenState extends State<ManageChildScreen> {
  // Which child's detail panel is expanded (null = none)
  int? _expandedId;
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        title: Text('Delete ${child.name}?',
            style:
                TextStyle(color: widget.T.text, fontWeight: FontWeight.w700)),
        content: Text(
        ...
        actions: [
          ...
          TextButton(
            ...
            child: Text('Delete',
                style: TextStyle(
                    color: widget.T.red, fontWeight: FontWeight.w700)),
          ),
        ],
      ),
    );
          ...
          if (widget.children.isEmpty)
            Container(
              ...
              child: Column(children: [
                ...
                Text('Tap "+ Add" above to register a child.',
                      ...
                      child: Row(
                        children: [
                              ...
                              child: Column(
                                ...
                                Row(children: [
                                  Container(
                                      ...
                                      decoration: BoxDecoration(
                                          color:
                                              child.online ? T.green : T.muted,
                                          shape: BoxShape.circle)),
                                  const SizedBox(width: 4),
                                  Text(child.online ? 'Online' : 'Offline',
                                      style: TextStyle(
                                          color:
                                              child.online ? T.green : T.muted,
                                          fontSize: 10,
                          ...
                          Row(children: [
                            ...
                            GestureDetector(
                              onTap: () => setState(() =>
                                  _expandedId = isExpanded ? null : child.id),
                              child: Container(
                                width: 34,
                                height: 34,
                                decoration: BoxDecoration(
